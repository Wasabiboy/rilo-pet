...
This repo contains **two related things**, intentionally kept together:

### 1. `rilo-pet/` — the browser extension
A Chromium and Firefox extension (Manifest V3) that injects the floating pet into pages, watches `rilo.studio` for task-completion signals, and fires OS-level notifications.

→ See [`rilo-pet/README.md`](rilo-pet/README.md) for install and developer details.

### 2. `rilo-pet/rilo-integration/` — a proposal for the Rilo team
...
→ See [`rilo-pet/rilo-integration/README.md`](rilo-pet/rilo-integration/README.md) for the event contract, integration examples, and rationale.
...
3. Click **Load unpacked** and pick the `rilo-pet/` folder.
4. The pet appears on the next webpage you load.

Full instructions including Firefox in [`rilo-pet/README.md`](rilo-pet/README.md).
